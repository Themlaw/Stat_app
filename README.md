...
## Global pipeline
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./ressources/schema_dark.svg" width="85%">
  <img alt="Architecture de la pipeline de causalité" src="./ressources/schema_light.svg" width="85%">
</picture>
## Project structure
